    ...
    <div class="page-header">
      <div class="header-content">
        <div class="header-left">
          ...
          <div>
            <h1 class="page-title">Daftar Pesanan Pembelian Karton Box</h1>
            <p class="page-subtitle">Kelola purchase order khusus karton box</p>
          </div>
        </div>
        <div class="header-actions">
          <router-link :to="{ name: 'BuatPembelianKarton' }" class="btn-header btn-primary">
