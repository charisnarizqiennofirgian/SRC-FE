      ...
      <div class="header-content">
        <div class="header-left">
          ...
          <div class="header-text">
            <h1 class="page-title">Laporan Stok Kayu Logs</h1>
            <p class="page-subtitle">Daftar stok untuk kategori Kayu Logs.</p>
          </div>
        </div>
    ...
    <div v-else class="content-card report-card">
      <div class="card-header-report">
        <div class="report-header-left">
          ...
          <h2 class="card-title">Daftar Stok Kayu Logs</h2>
        </div>
...
.page-header {
  ...
  border-radius: 24px;
  margin-bottom: 24px;
  box-shadow: 0 12px 40px rgba(146, 64, 14, 0.25);
  position: relative;
  overflow: hidden;
}
