      ...
      <div class="header-content">
        <div class="header-left">
          ...
          <div class="header-text">
            <h1 class="page-title">Laporan Bahan Operasional</h1>
            <p class="page-subtitle">Daftar stok untuk kategori Operasional, Bahan Penolong.</p>
          </div>
        </div>
...
const fetchReportData = async () => {
  ...
  try {
    const params = {
      categories: 'Bahan Operasional,Bahan Penolong',
