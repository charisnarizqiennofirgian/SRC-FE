...
.process-arrow { font-size: 1.25rem; color: #075985; font-weight: 700; }
...
.btn-submit-sanding { background: linear-gradient(135deg, #0369a1, #075985); color: white; box-shadow: 0 4px 12px rgba(3,105,161,0.35); }
